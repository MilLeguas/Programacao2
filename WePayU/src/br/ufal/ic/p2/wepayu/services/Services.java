...
public class Services {
    ...
    public Services() throws Exception {carregar();}
    ...
    public String criarEmpregado(String nome, String endereco, String tipo, String salario) throws Exception {
        ...
        String id = darId(i++);
        Empregado empregado;
        if (tipo.equals("assalariado")) empregado = new Assalariado(id, nome, endereco, tipo, salarioDouble);
        else empregado = new Horista(id, nome, endereco, tipo, salarioDouble);
